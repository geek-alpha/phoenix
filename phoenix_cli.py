#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Phoenix CLI —— 终端里的 Phoenix。

    phoenix                        交互模式
    phoenix "改一下 web/style.css"   单次任务
    echo "..." | phoenix           管道输入
    phoenix -v "..."               显示思维链
    phoenix --user default "..."   复用浏览器会话的记忆（默认独立为 cli）
...
def main() -> int:
    ap = argparse.ArgumentParser(prog="phoenix", description="Phoenix CLI —— 终端里的 Phoenix")
